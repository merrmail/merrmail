...
public class StringExtensionsTests
{
    ...
    [InlineData("Carriage\rReturn", "Q2FycmlhZ2UgXHJSZXR1cm4=")]
    ...
    [InlineData("TGluZTEKTGluZTI=", "Line1\nLine2")]
    [InlineData("Q2FycmlhZ2UgXHJSZXR1cm4=", "Carriage\rReturn")]
    [InlineData("RG91YmxlXFxCYWNrc2xhc2g=", "Double\\Backslash")]
    [InlineData("V2l0aFxEYXJrZXJnXFxDaGFyYWN0ZXJz", "With\\Escaping\\Characters")]
    public void ToDecodedString_ShouldDecodeStringAndRemoveEscapes(string input, string expected)
    {
        // Act
